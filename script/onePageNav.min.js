...
function onePageNav(){var _this=this;var _ref=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},_ref$navLinksSelector=_ref.navLinksSelector,navLinksSelector=_ref$navLinksSelector===void 0?"nav a":_ref$navLinksSelector,_ref$defaultLinkActiv=_ref.defaultLinkActive,defaultLinkActive=_ref$defaultLinkActiv===void 0?true:_ref$defaultLinkActiv,_ref$updateATagClass=_ref.updateATagClass,updateATagClass=_ref$updateATagClass===void 0?true:_ref$updateATagClass,_ref$changeOffset=_ref.changeOffset,changeOffset=_ref$changeOffset===void 0?50:_ref$changeOffset,_ref$parentsObtaining=_ref.parentsObtainingActiveClass,parentsObtainingActiveClass=_ref$parentsObtaining===void 0?[]:_ref$parentsObtaining,_ref$setClassesOnSect=_ref.setClassesOnSections,setClassesOnSections=_ref$setClassesOnSect===void 0?false:_ref$setClassesOnSect,_ref$exactMatch=_ref.exactMatch,exactMatch=_ref$exactMatch===void 0?false:_ref$exactMatch,_ref$allowedPaths=_ref.allowedPaths,allowedPaths=_ref$allowedPaths===void 0?undefined:_ref$allowedPaths,_ref$anchorActiveClas=_ref.anchorActiveClass,anchorActiveClass=_ref$anchorActiveClas===void 0?"active":_ref$anchorActiveClas,_ref$sectionActiveCla=_ref.sectionActiveClass,sectionActiveClass=_ref$sectionActiveCla===void 0?"active":_ref$sectionActiveCla,_ref$defaultActiveEle=_ref.defaultActiveElement,defaultActiveElement=_ref$defaultActiveEle===void 0?undefined:_ref$defaultActiveEle,_ref$updateHash=_ref.updateHash,updateHash=_ref$updateHash===void 0?false:_ref$updateHash,_ref$saveHashBetweenS=_ref.saveHashBetweenSections,saveHashBetweenSections=_ref$saveHashBetweenS===void 0?true:_ref$saveHashBetweenS,_ref$debugLine=_ref.debugLine,_debugLine=_ref$debugLine===void 0?false:_ref$debugLine,_ref$onChange=_ref.onChange,onChange=_ref$onChange===void 0?[]:_ref$onChange;_classCallCheck(this,onePageNav);_defineProperty(this,"set",function(option,value){_this[option]=value;_this.refresh();});_defineProperty(this,"refresh",function(){_this.newlyInitialized=true;_this.initialize();});_defineProperty(this,"initialize",function(){if(_this.shouldTerminate())return;_this.findLinks();if(!_this.navLinks){console.debug("The selector did not match any elements - `"+_this.navLinksSelector+"`");return;}_this.findRelatedSections();if(!_this.sections){console.debug("No sections found");return;}_this.handleDebugLine();_this.handleScrollListener();_this.handleOutput();});_defineProperty(this,"shouldTerminate",function(){if(!_this.allowedPaths)return false;var currentPath=document.location.pathname.trim();var pathMatchesAllowedPaths=_this.allowedPaths.some(function(el){return currentPath.match(el.trim());});return!pathMatchesAllowedPaths;});_defineProperty(this,"findLinks",function(){_this.navLinks=_toConsumableArray(document.querySelectorAll(_this.navLinksSelector));});_defineProperty(this,"findRelatedSections",function(){var hashes=_this.navLinks.map(function(el){return el.hash;}).filter(function(el){return el;});_this.sections=_toConsumableArray(document.querySelectorAll(hashes.join(", ")));});_defineProperty(this,"handleScrollListener",function(){if(_this.currentWindowScrollListener){removeEventListener(scroll,_this.currentWindowScrollListener);}_this.currentWindowScrollListener=window.addEventListener("scroll",function(){return _this.handleOutput();});});_defineProperty(this,"handleOutput",function(){var foundSection=_this.findCurrentSection();_this.updateCurrentSection(foundSection);if(_this.sectionChanged()||_this.newlyInitialized){_this.newlyInitialized=false;_this.clearClasses();_this.handleDefaultLinkActive();_this.handleHash();_this.handleCallbacks();if(_this.noSectionActive())return;_this.handleSectionClasses();_this.addActiveClassesOnNavigationLinks();}});_defineProperty(this,"findCurrentSection",function(){return _this.sections.filter(function(section){return _this.isBelowSectionOffsetTop(section);}).at(-1);});_defineProperty(this,"updateCurrentSection",function(newSection){_this.previousSection=_this.currentSection;if(!_this.exactMatch){_this.currentSection=newSection!==null&&newSection!==void 0?newSection:_this.handleDefaultLinkActive();}else{_this.currentSection=_this.isAboveSectionOffsetBottom(newSection)?newSection:_this.handleDefaultLinkActive();}});_defineProperty(this,"clearClasses",function(){_this.navLinks.forEach(function(link){_this.removeActiveClass(link);});_this.sections.forEach(function(el){el.classList.remove(_this.sectionActiveClass);});});_defineProperty(this,"handleDefaultLinkActive",function(){if(_this.defaultActiveElement){_this.elementDefaultActive=document.querySelector(_this.defaultActiveElement);}if(_this.noSectionActive()&&_this.defaultLinkActive){var _this$elementDefaultA;_this.addActiveClass((_this$elementDefaultA=_this.elementDefaultActive)!==null&&_this$elementDefaultA!==void 0?_this$elementDefaultA:_this.navLinks[0]);}});_defineProperty(this,"handleHash",function(){if(!_this.updateHash){return;}else if(_this.exactMatch&&!_this.currentSection&&_this.saveHashBetweenSections&&_this.insideWorkingArea()){var lastSectionAbove=_this.findCurrentSection();history.pushState({},"",lastSectionAbove?"#"+lastSectionAbove.id:" ");}else{history.pushState({},"",_this.currentSection?"#"+_this.currentSection.id:" ");}});_defineProperty(this,"handleCallbacks",function(){_this.onChange.forEach(function(callback){callback(_this);});});_defineProperty(this,"handleSectionClasses",function(){if(_this.setClassesOnSections){_this.currentSection.classList.add(_this.sectionActiveClass);}});_defineProperty(this,"addActiveClassesOnNavigationLinks",function(){var currentlyActiveLinks=_this.findLinksWithHashEqualTocurrentSectionId(_this.navLinks,_this.currentSection.id);currentlyActiveLinks.forEach(function(activeLink){return _this.addActiveClass(activeLink);});});_defineProperty(this,"findLinksWithHashEqualTocurrentSectionId",function(links,hash){return links.filter(function(el){return el.hash.includes(hash);});});_defineProperty(this,"addActiveClass",function(el){if(_this.updateATagClass){el.classList.add(_this.anchorActiveClass);}_this.parentsObtainingActiveClass.forEach(function(parentSelector){el.closest(parentSelector).classList.add(_this.anchorActiveClass);});});_defineProperty(this,"removeActiveClass",function(el){if(_this.updateATagClass){el.classList.remove(_this.anchorActiveClass);}_this.parentsObtainingActiveClass.forEach(function(parentSelector){el.closest(parentSelector).classList.remove(_this.anchorActiveClass);});});_defineProperty(this,"sectionChanged",function(){return _this.currentSection!=_this.previousSection;});_defineProperty(this,"noSectionActive",function(){return _this.currentSection==undefined;});_defineProperty(this,"currentOffset",function(){return window.scrollY+window.innerHeight/(100/_this.changeOffset);});_defineProperty(this,"insideWorkingArea",function(){return _this.currentOffset()>_this.sections.at(0).getBoundingClientRect().top+document.documentElement.scrollTop;});_defineProperty(this,"isExactlyInsideSection",function(section){return _this.isBelowSectionOffsetTop(section)&&_this.isAboveSectionOffsetBottom(section);});_defineProperty(this,"isAboveSectionOffsetTop",function(section){if(!section){return false;}return _this.currentOffset()<section.getBoundingClientRect().top+document.documentElement.scrollTop;});_defineProperty(this,"isAboveSectionOffsetBottom",function(section){if(!section){return false;}return _this.currentOffset()<section.getBoundingClientRect().top+document.documentElement.scrollTop+section.offsetHeight;});_defineProperty(this,"isBelowSectionOffsetTop",function(section){if(!section){return false;}return _this.currentOffset()>section.getBoundingClientRect().top+document.documentElement.scrollTop;});_defineProperty(this,"isBelowSectionOffsetBottom",function(section){if(!section){return false;}return _this.currentOffset()>section.getBoundingClientRect().top+document.documentElement.scrollTop+section.offsetHeight;});_defineProperty(this,"handleDebugLine",function(){_this.debugLines.forEach(function(el){return el.remove();});if(_this.debugLine)_this.createDebugLine();});_defineProperty(this,"createDebugLine",function(){var debugLine=document.createElement("div");debugLine.setAttribute("style","position: fixed;width: 100%;background: red;height: 2px;top: calc(".concat(_this.changeOffset,"% - 1px);"));_this.debugLines.push(debugLine);document.body.appendChild(debugLine);});this.navLinksSelector=navLinksSelector;this.defaultLinkActive=defaultLinkActive;this.updateATagClass=updateATagClass;this.changeOffset=changeOffset;this.parentsObtainingActiveClass=parentsObtainingActiveClass;this.setClassesOnSections=setClassesOnSections;this.debugLine=_debugLine;this.exactMatch=exactMatch;this.allowedPaths=allowedPaths;this.anchorActiveClass=anchorActiveClass;this.sectionActiveClass=sectionActiveClass;this.defaultActiveElement=defaultActiveElement;this.updateHash=updateHash;this.onChange=onChange;this.saveHashBetweenSections=saveHashBetweenSections;this.sections=[];this.debugLines=[];this.initialize();}/**
